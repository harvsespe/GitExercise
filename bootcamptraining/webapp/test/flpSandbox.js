		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpbootcamptraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpbootcamptraining-display": {
								"semanticObject": "zbtpbootcamptraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.bootcamptraining",
									"url": sap.ui.require.toUrl("zbtp/bootcamptraining")
								}
							}
						}
					}
